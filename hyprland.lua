...
hl.config({
  general = {
    ...
    border_size = 2,
    col = {
      active_border = { colors = { "rgba(fb0067ee)", "rgba(c4a535ee)" }, angle = 180 },
      inactive_border = "rgba(0e712ecc)",
    },
  ...
  group = {
    col = {
      border_active = { colors = { "rgba(659ff155)", "rgba(73c9f222)" }, angle = 60 },
      border_inactive = "rgba(766c9322)",
    ...
    groupbar = {
      ...
      text_color = "#e8ece6",
      text_color_inactive = "rgba(e8ece690)",
      col = {
